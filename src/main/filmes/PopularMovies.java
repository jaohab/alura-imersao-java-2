...
public class PopularMovies extends Style {
    ...
    public void showPopularMovies() throws Exception {
        ...
        // String URL ="https://imdb-api.com/en/API/MostPopularMovies/".concat(key);
        ...
        System.out.println(T_VERDE + NEGRITO + "FILMES MAIS POPULARES\n" + RESETAR);
