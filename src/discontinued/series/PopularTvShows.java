...
public class PopularTvShows extends Style {
    ...
    public void showPopularTvShows() throws Exception {
        ...
        // String URL = "https://imdb-api.com/en/API/MostPopularTVs/".concat(key);
        ...
        System.out.println(T_VERDE + NEGRITO + "SÉRIES MAIS POPULARES\n" + RESETAR);

        for (Map<String, String> show : listaDeFilmes) {
            System.out.println("Título: " + NEGRITO + show.get("title") + RESETAR);
            System.out.println(T_AZUL + ITALICO + show.get("image") + RESETAR);
